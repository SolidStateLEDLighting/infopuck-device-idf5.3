...
enum class SYS_INIT : uint8_t
{
    ...
    // Create_IMU,
    // Wait_On_IMU,
    Create_I2C,  // The System diagram clearly shows that we must enable/active our Touch and IMU before
    Wait_On_I2C, // attaching those devices to the I2C bus.
